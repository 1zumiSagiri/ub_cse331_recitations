...
\begin{document}
    ...
    \author{Vincent Chan}
    \title{CSE331 Week 1: Introduction}
    \date{\today}
    ...
    \section{Proof Techniques}
        ...
        \subsection{Proof by Counterexample}
            \begin{frame}
                ...
                To prove that a statement is false, provide a counterexample.
            \end{frame}

            \begin{frame}
                \frametitle{Proof by Counterexample}
                \begin{block}{Example}
                    Prove that the statement ``There's no way to fail CSE331'' is false.
                \end{block}
                \begin{block}{Proof}
                    Well, there are a lot of ways to get you to fail this course, in CSE331 syllabus we know that 
                    \alert{any academic violation involves the use of ChatGPT will get an F in this course}.
                \end{block}
            \end{frame}
    ...
    \begin{frame}
        ...
        \bigskip
        Also try to complete Homework 0 to get feedback on your proofs and prepare for the upcoming assignments.
    \end{frame}
